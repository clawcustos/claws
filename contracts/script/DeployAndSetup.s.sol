...
contract DeployAndSetup is Script {
    function run() external {
        ...
        // New DD additions (7)
        handles[24] = "aixbt_agent";
        handles[25] = "owockibot";
        handles[26] = "BrackyHQ";
        handles[27] = "clawcian";
        handles[28] = "Dragon_Bot_Z";
        handles[29] = "Wach_AI";
        handles[30] = "clonkbot";
        
        // Additional approved (2)
        handles[31] = "mferGPT";
        handles[32] = "emberclawd";
        
        // Dexscreener trending agents (4)
        handles[33] = "FelixCraftAI";
        handles[34] = "emmet_ai_";
        handles[35] = "tellrbot";
        handles[36] = "ArAIstotle";
