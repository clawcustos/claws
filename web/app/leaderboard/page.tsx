...
export default function LeaderboardPage() {
  ...
  return (
    <>
      <main style={{ padding: 'calc(var(--header-height) + env(safe-area-inset-top, 0px) + var(--ticker-height, 32px) + 1rem) 1rem calc(var(--nav-height, 70px) + env(safe-area-inset-bottom, 0px) + 2rem)', maxWidth: '700px', margin: '0 auto' }}>
